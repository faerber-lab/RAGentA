...
class FalconAgent:
    ...
    def generate(self, prompt, max_new_tokens=256):
        ...
        # Format as a chat message for Falcon models
        ...
        for attempt in range(max_retries):
            try:
                ...
                # If response is empty or just contains the assistant token
                if not text_response or text_response.strip() == "<|assistant|>":
                    return (
                        "I don't have enough information to provide a specific answer."
                    )
